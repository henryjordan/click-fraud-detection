...
# Science Academy.
#
# Este projeto tem como objetivo criar um algoritmo de aprendizagem de máquina
# que possa prever se um usuário fará o download de um aplicativo depois de
...
setwd("~/FCD/BigDataRAzure/Projetos/Projeto1")
getwd()
...
typeColNum <- grep('is_',names(dados))
